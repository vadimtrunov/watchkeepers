...
- Measured numbers: load suite total 5.22 s wall-clock. `BenchmarkRateLimiter_Tier2_Allow_Hot` 71.78 ns/op, 0 B/op, 0 allocs/op. `BenchmarkRateLimiter_Tier2_Allow_Empty` 70.14 ns/op, 0 B/op, 0 allocs/op.
